...
import SuporteMultScreen from './SuporteMultScreen';
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={{ flexDirection: 'row', justifyContent: 'space-between', marginTop: 50, gap: 80 }}>
        <ActionCards tela={"Leitura"} img={require('./assets/audio.png')} titulo="Leitura em voz alta" texto="Ouça qualquer texto de forma clara e natural." /> 
        <ActionCards tela={"SuporteMult"} img={require('./assets/multimaior.png')} titulo="Suporte Multilíngue" texto="Converta textos em vários idiomas." />
        <ActionCards tela={"Vozes"} img={require('./assets/microfone.png')} titulo="Vozes Naturais" texto="Áudios realistas que soam humanos" />
        <ActionCards tela={"Leitura"} img={require('./assets/deficiente.png')} titulo="Acessibilidade
...
const RootStack = createNativeStackNavigator({
  screens: {
    ...
    SuporteMult: SuporteMultScreen,
    VozesNaturais: VozesScreen, //vozes:
    //sobre:
  },
});
